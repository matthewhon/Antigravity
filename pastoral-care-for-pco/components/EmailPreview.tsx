...
const resolveMergeTags = (html: string) => {
  ...
  return html
    ...
    .replace(/\{church\.name\}|\{churchName\}/gi, span('Grace Church'))
    .replace(/\{church\.phone\}|\{churchPhone\}/gi, span('(615) 555-0199'))
    .replace(/\{church\.address\}|\{churchAddress\}/gi, span('123 Church St, Nashville, TN'))
    .replace(/\{church\.website\}|\{churchWebsite\}/gi, span('https://gracechurch.org'))
