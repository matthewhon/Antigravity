                    ...
                    <div className="bg-white dark:bg-slate-850 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm mb-8 transition-colors">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={handleToggleCensus} className={`w-14 h-8 rounded-full p-1 transition-all duration-300 ${showCensus ? 'bg-indigo-600' : 'bg-slate-200 dark:bg-slate-700'}`}><div className={`w-6 h-6 bg-white rounded-full shadow-md transition-transform duration-300 ${showCensus ? 'translate-x-6' : ''}`}></div></button>
                            </div>
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={handleToggleCityPenetration} className={`w-14 h-8 rounded-full p-1 transition-all duration-300 ${showCityPenetration ? 'bg-indigo-600' : 'bg-slate-200 dark:bg-slate-700'}`}><div className={`w-6 h-6 bg-white rounded-full shadow-md transition-transform duration-300 ${showCityPenetration ? 'translate-x-6' : ''}`}></div></button>
                            </div>
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={handleToggleMissionalGap} className={`w-14 h-8 rounded-full p-1 transition-all duration-300 ${showMissionalGap ? 'bg-indigo-600' : 'bg-slate-200 dark:bg-slate-700'}`}><div className={`w-6 h-6 bg-white rounded-full shadow-md transition-transform duration-300 ${showMissionalGap ? 'translate-x-6' : ''}`}></div></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white dark:bg-slate-850 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm transition-colors">
                            ...
                            <div className="flex flex-col gap-3 mb-6">
                                ...
                                <div className="flex gap-2">
                                    <select value={defMinistryId} onChange={(e) => setDefMinistryId(e.target.value)} className="flex-1 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-bold outline-none focus:ring-2 focus:ring-indigo-500 text-slate-900 dark:text-white">
                                        <option value="">Select Ministry...</option>
                                        {ministries.map(m => <option key={m.id} value={m.id}>{m.name}</option>)}
                                    </select>
                                    <select value={defType} onChange={(e) => setDefType(e.target.value as any)} className="w-24 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-bold outline-none focus:ring-2 focus:ring-indigo-500 text-slate-900 dark:text-white">
