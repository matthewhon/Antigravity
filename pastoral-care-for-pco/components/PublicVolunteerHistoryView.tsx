                ...
                <div className="space-y-4">
                    <div className="bg-white rounded-[2rem] shadow-xl border border-slate-100 p-6">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                            ...
                            {/* Filters at the top right (or stacked on mobile) */}
                            {groupedContacts.length > 0 && (
                                <div className="flex flex-wrap items-center gap-4 bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        ...
                                        />
                                        <span className="text-sm text-slate-700 font-bold">Has Notes</span>
                                    </label>
                                    ...
                                    <select
                                        ...
                                        className="bg-white border border-slate-200 text-slate-700 font-bold text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block p-2 outline-none shadow-sm"
                                    >
