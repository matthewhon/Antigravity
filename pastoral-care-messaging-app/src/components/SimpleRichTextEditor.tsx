...
export const SimpleRichTextEditor = forwardRef<SimpleRichTextEditorRef, {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: `prose prose-sm max-w-none text-slate-900 dark:text-white focus:outline-none flex-1 break-words overflow-x-hidden max-w-full`,
    ...
    return (
        <div className="w-full border border-slate-200 dark:border-slate-600 rounded-2xl bg-white dark:bg-slate-800 focus-within:ring-2 focus-within:ring-violet-500 overflow-hidden flex flex-col">
            ...
            <EditorContent editor={editor} className="flex-1 overflow-y-auto w-full max-w-full overflow-x-hidden" />
        </div>
    );
});
